...
//------------------------------------------ADD HERE--------------------------------------------------------------------//
void Optimizer::LocalVisualInertialBA(KeyFrame* pCurKF, const list<KeyFrame*> &lLocalKeyFrames, bool *pbStopFlag, Map *pMap, Eigen::Vector3d &gw)
{
    //Check current keyframe is in local window
...
//
//        Eigen::Vector3d tc0bk = pKFi->Ps;
//        Eigen::Matrix3d R = pKFi->Rc0bk;
//        Eigen::Matrix4d EigTcw;
//        EigTcw = Eigen::Matrix4d::Identity();
//        EigTcw.block<3,3>(0,0) = R.transpose();
//        EigTcw.block<3,1>(0,3) = -R.transpose()*tc0bk;
//
//        for(int i=0;i<4;i++)
//        {
//            for(int j=0;j<4;j++)
//            {
//                mTcw.at<float>(i,j) = EigTcw(i,j);
//            }
//
//        }
//
...
//                e->setVertex(1, dynamic_cast<g2o::OptimizableGraph::Vertex*>(optimizer.vertex(5*pKFi->mnId+3)));
...
//
//    }
//    cout<<"Check inlier observations Before"<<endl;
